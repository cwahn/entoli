...
//         while pos < self.staged_s_exprs.len() {
//             let s_expr = &self.staged_s_exprs[pos];
//             match &*s_expr.get() {
//                 SExpr::List(s_exprs) => {
//                     // Should be either type annotation, data binding, data type, trait or module
//                     match s_exprs.as_ref() {
//                         [SExpr::TypeAnnot, SExpr::VarIdent(ident), ..] => {
//                             // Expect next s_expr to be data binding
//                             if let Some(next_s_expr) = self.staged_s_exprs.get(pos + 1) {
//                                 if let SExpr::List(data_binding_s_exprs) = next_s_expr.as_ref() {
//                                     match data_binding_s_exprs.as_slice() {
//                                         [SExpr::Binding, SExpr::VarIdent(binding_ident), ..] => {
//                                             if b
//                                         }
//                                     }
//                                 }
...
//                             } else {
//                                 return Err(ident.0.error("Expected data binding after type annotation of this identifier but found no other S-Expression"));
//                             }
//                         }
//                         _ => {}
//                     }
